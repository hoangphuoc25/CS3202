...
void Test10_00_NextStar::setUp()
{
    this->NEXT_STAR_00_PROG = 
        "procedure next {\
            a = 1;\
            while b2 {\
                if c3 then {\
...
void Test10_00_NextStar::tearDown() {}

CPPUNIT_TEST_SUITE_REGISTRATION(Test10_00_NextStar);
...
void Test10_00_NextStar::test_next_star_stmt_00()
{
        string queryStr;
    ...
    const string& simpleProg = this->NEXT_STAR_00_PROG;
...
void Test10_00_NextStar::test_next_star_assign_00()
{
    string queryStr;
    QueryEvaluator evaluator;
    list<string> resultList;
    ...
    evaluator.evaluate(queryStr, resultList);
    stringSet = SetWrapper<string>(resultList);
    CPPUNIT_ASSERT_EQUAL(SetWrapper<string>(6, "1","5","8",
        "14","16","18"),
            stringSet);
    ...
    evaluator.evaluate(queryStr, resultList);
    stringSet = SetWrapper<string>(resultList);
    CPPUNIT_ASSERT_EQUAL(SetWrapper<string>(3, "1","5","8"),
            stringSet);
    ...
    evaluator.evaluate(queryStr, resultList);
    stringSet = SetWrapper<string>(resultList);
    CPPUNIT_ASSERT_EQUAL(SetWrapper<string>(4, "1","5","8","14"),
            stringSet);
...
void Test10_00_NextStar::test_next_star_while_00()
{
    string queryStr;
    QueryEvaluator evaluator;
    list<string> resultList;
    ...
    evaluator.evaluate(queryStr, resultList);
    stringSet = SetWrapper<string>(resultList);
    CPPUNIT_ASSERT_EQUAL(SetWrapper<string>(2, "2","10"),
            stringSet);
...
void Test10_00_NextStar::test_next_star_if_00()
{
    string queryStr;
    QueryEvaluator evaluator;
    list<string> resultList;
    ...
    evaluator.evaluate(queryStr, resultList);
    stringSet = SetWrapper<string>(resultList);
    CPPUNIT_ASSERT_EQUAL(SetWrapper<string>(3,"3","6","12"),
            stringSet);
...
void Test10_00_NextStar::test_next_star_call_00()
{
    string queryStr;
    QueryEvaluator evaluator;
    list<string> resultList;
    ...
    evaluator.evaluate(queryStr, resultList);
    stringSet = SetWrapper<string>(resultList);
    CPPUNIT_ASSERT_EQUAL(SetWrapper<string>(4,"4","7","9","11"),
            stringSet);
    ...
    queryStr = "call c1,c2;";
    queryStr += " Select c2 such that Next*(c1,c2)";
    evaluator.evaluate(queryStr, resultList);
    stringSet = SetWrapper<string>(resultList);
    CPPUNIT_ASSERT_EQUAL(SetWrapper<string>(5,"4","7","9","11","17"),
            stringSet);
