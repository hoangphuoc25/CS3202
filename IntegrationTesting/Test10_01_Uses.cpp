...
void Test10_01_Uses::test_uses_stmt_var()
{
    string queryStr;
    QueryEvaluator evaluator;
    list<string> resultList;
    ...
    const string& simpleProg = this->USES_00_SIMPLE_PROG;
    evaluator.parseSimple(simpleProg);
    queryStr = "assign a1; variable v1; stmt sgb1; ";
    queryStr += " Select <a1,v1,sgb1> such that ";
    queryStr += " Modifies(a1,v1) and Uses(sgb1, v1)";
    evaluator.evaluate(queryStr, resultList);
    stringSet = SetWrapper<string>(resultList);
    // Modifies(a1,v1)
    // a1 | v1
    ...
    // a1 | v1 | sgb1
    // sgb1 = assign
    // (7,destruct,30), (20,google,53), (25,this,20), (25,this,28)
    // (25,this,37), (25,this,49)
    // sgb1 = call
    // (7,destruct,24), (20,google,24), (20,google,31), (25,this,24)
    // (25,this,31)
    // sgb1 = if
...
void Test10_01_Uses::test_uses_progline_var()
{
    string queryStr;
    QueryEvaluator evaluator;
    list<string> resultList;
    ...
    const string& simpleProg = this->USES_00_SIMPLE_PROG;
    evaluator.parseSimple(simpleProg);
    queryStr = "assign a1; variable v1; prog_line Q561d; ";
    queryStr += " Select <a1,v1,Q561d> such that ";
    queryStr += " Modifies(a1,v1) and Uses(Q561d, v1)";
    evaluator.evaluate(queryStr, resultList);
    stringSet = SetWrapper<string>(resultList);
    // Modifies(a1,v1)
    // a1 | v1
