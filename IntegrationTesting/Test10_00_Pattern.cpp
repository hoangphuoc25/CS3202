...
void Test10_00_Pattern::test_2() {
    ...
    //a("x", "b+c")
    queryStr = "assign a; variable v;";
    queryStr += "Select a pattern a(\"life\", \"life - 1\")";
    evaluator.evaluate(queryStr, resultList);
    stringSet = SetWrapper<string>(resultList);
    CPPUNIT_ASSERT_EQUAL(stringSet, SetWrapper<string>(1, "6"));

    queryStr = "assign a; variable v;";
    queryStr += "Select a pattern a(\"life\", \"life\")";
    evaluator.evaluate(queryStr, resultList);
    stringSet = SetWrapper<string>(resultList);
    CPPUNIT_ASSERT_EQUAL(stringSet, SetWrapper<string>(0));

    queryStr = "assign a; variable v;";
    queryStr += "Select a pattern a(\"abc\", \"1\")";
    evaluator.evaluate(queryStr, resultList);
    stringSet = SetWrapper<string>(resultList);
    CPPUNIT_ASSERT_EQUAL(stringSet, SetWrapper<string>(2, "18", "20"));

    queryStr = "assign a; variable v;";
    queryStr += "Select a pattern a(\"true\", \"false\")";
    evaluator.evaluate(queryStr, resultList);
    stringSet = SetWrapper<string>(resultList);
    CPPUNIT_ASSERT_EQUAL(stringSet, SetWrapper<string>(1, "15"));

    //a("x", _"b+c"_)
    queryStr = "assign a; variable v;";
    queryStr += "Select a pattern a(\"true\", _\"false\"_)";
    evaluator.evaluate(queryStr, resultList);
    stringSet = SetWrapper<string>(resultList);
    CPPUNIT_ASSERT_EQUAL(stringSet, SetWrapper<string>(1, "15"));

    queryStr = "assign a; variable v;";
    queryStr += "Select a pattern a(\"number\", _\"1+hp\"_)";
    evaluator.evaluate(queryStr, resultList);
    stringSet = SetWrapper<string>(resultList);
    CPPUNIT_ASSERT_EQUAL(stringSet, SetWrapper<string>(0));

    queryStr = "assign a; variable v;";
    queryStr += "Select a pattern a(\"number\", _\"hp+life\"_)";
    evaluator.evaluate(queryStr, resultList);
    stringSet = SetWrapper<string>(resultList);
    CPPUNIT_ASSERT_EQUAL(stringSet, SetWrapper<string>(0));

    queryStr = "assign a; variable v;";
    queryStr += "Select a pattern a(\"number\", _\"number + 1\"_)";
    evaluator.evaluate(queryStr, resultList);
    stringSet = SetWrapper<string>(resultList);
    CPPUNIT_ASSERT_EQUAL(stringSet, SetWrapper<string>(1, "13"));
    ...
    //a(v, "b+c")
    queryStr = "assign a; variable v;";
    queryStr += "Select <a, v> pattern a(v, \"number + 1\")";
    evaluator.evaluate(queryStr, resultList);
    stringSet = SetWrapper<string>(resultList);
    CPPUNIT_ASSERT_EQUAL(stringSet, SetWrapper<string>(0));
    ...
    //a(_, _"b"_)
    queryStr = "assign a;";
    queryStr += "Select a pattern a(_, _\"life - 1\"_)";
    evaluator.evaluate(queryStr, resultList);
    stringSet = SetWrapper<string>(resultList);
    CPPUNIT_ASSERT_EQUAL(stringSet, SetWrapper<string>(1, "6"));

    queryStr = "assign a;";
    queryStr += "Select a pattern a(_, _\"number + 1 + hp\"_)";
    evaluator.evaluate(queryStr, resultList);
    stringSet = SetWrapper<string>(resultList);
    CPPUNIT_ASSERT_EQUAL(stringSet, SetWrapper<string>(1, "13"));

    queryStr = "assign a;";
    queryStr += "Select a pattern a(_, _\"number + 1 + hp + life\"_)";
    evaluator.evaluate(queryStr, resultList);
    stringSet = SetWrapper<string>(resultList);
    CPPUNIT_ASSERT_EQUAL(stringSet, SetWrapper<string>(1, "13"));
