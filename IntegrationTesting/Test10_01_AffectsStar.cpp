...
#include <set>
#include <string>
#include "Test10_01_AffectsStar.h"
...
void Test10_01_AffectsStar::setUp() 
{
    this->AFFECTS_STAR_01_PROG = 
        "procedure affects{\
            while w1 {\
                if i2 then {\
                    if i3 then {\
...
void Test10_01_AffectsStar::tearDown() {}

CPPUNIT_TEST_SUITE_REGISTRATION(Test10_01_AffectsStar);
...
void Test10_01_AffectsStar::test_affects_star_stmt_01()
{
    string queryStr;
    ...
    const string& simpleProg = this->AFFECTS_STAR_01_PROG;
    evaluator.parseSimple(simpleProg);

    queryStr = "assign a1,a2;";
    queryStr += " Select a1 such that Affects(a2,a1) and Affects*(a1,a2)";
    evaluator.evaluate(queryStr, resultList);
    stringSet = SetWrapper<string>(resultList);
    CPPUNIT_ASSERT_EQUAL(SetWrapper<string>(6,"5","6","9","13","16","15"),
            stringSet);

    queryStr = "assign a1,a2;while w;";
