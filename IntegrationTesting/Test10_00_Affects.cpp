...
CPPUNIT_TEST_SUITE_REGISTRATION(Test10_00_Affects);
...
void Test10_00_Affects::test_affects_stmt_00()
{
    string queryStr;
    ...
    const string& simpleProg = this->AFFECTS_00_PROG;
