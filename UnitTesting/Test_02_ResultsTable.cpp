...
void Test_02_ResultsTable::test_syn_10_transaction_s()
{
    Record record;
    ResultsTable rTable;
    CPPUNIT_ASSERT_EQUAL(true, rTable.is_alive());
    ...
    CPPUNIT_ASSERT_EQUAL(true, rTable.is_alive());
    pair<const vector<Record> *, int> viPair =
            rTable.syn_10_transaction_begin("Club", "Player",
                    RV_STRING);
    CPPUNIT_ASSERT_EQUAL(0, viPair.second);
    const vector<Record>& orgRecords = *(viPair.first);
    CPPUNIT_ASSERT_EQUAL(6, (int)orgRecords.size());
    ...
    record.add_value("Italy");
    CPPUNIT_ASSERT_EQUAL(record, orgRecords[5]);
    rTable.syn_10_augment_new_row(0, "Wayne Rooney");
    rTable.syn_10_augment_new_row(0, "Robin Van Persie");
    rTable.syn_10_augment_new_row(2, "Cristiano Ronaldo");
    rTable.syn_10_augment_new_row(1, "Thierry Henry");
    rTable.syn_10_augment_new_row(4, "Alexandre Pato");
    rTable.syn_10_augment_new_row(3, "Lionel Messi");
    rTable.syn_10_augment_new_row(0, "Owen Hargreaves");
    rTable.syn_10_augment_new_row(3, "Andre Iniesta");
...
void Test_02_ResultsTable::test_syn_10_transaction_i()
{
    ResultsTable rTable;
    CPPUNIT_ASSERT_EQUAL(true, rTable.is_alive());
    rTable.syn_00_transaction_begin("Country", RV_STRING,
    ...
    CPPUNIT_ASSERT_EQUAL(true, rTable.is_alive());
    pair<const vector<Record> *, int> viPair =
            rTable.syn_10_transaction_begin("Season", "Temperature",
                    RV_INT);
    CPPUNIT_ASSERT_EQUAL(1, viPair.second);
    rTable.syn_10_augment_new_row(4, 34);
    rTable.syn_10_augment_new_row(3, 0);
    rTable.syn_10_augment_new_row(1, -10);
    rTable.syn_10_augment_new_row(7, 25);
    rTable.syn_10_transaction_end();
    CPPUNIT_ASSERT_EQUAL(true, rTable.is_alive());
    rTable.checkout_transaction_begin();
    Table *table = rTable.checkout_table("Country");
...
void Test_02_ResultsTable::test_absorb_table()
{
    Record record;
    ResultsTable rTable;
    bool boolVal;
    ...
    rTable.syn_00_add_row("Sony", "Japan");
    rTable.syn_00_add_row("Foxconn", "China");
    rTable.syn_00_add_row("Toyota", "Japan");
    rTable.syn_00_transaction_end();
    Table *table = new Table();
    table->add_rows_transaction_begin();
    table->add_row("Name", "Mr. A", "Age", 42);
    ...
    map<int, string>::const_iterator isIt = colToSyn.find(0);
    CPPUNIT_ASSERT(isIt != colToSyn.end());
    CPPUNIT_ASSERT_EQUAL(string("Company"), isIt->second);
    isIt = colToSyn.find(1);
    CPPUNIT_ASSERT(isIt != colToSyn.end());
    CPPUNIT_ASSERT_EQUAL(string("Country"), isIt->second);
    const map<string, int>& synToCol = table->get_synonym_to_col();
    CPPUNIT_ASSERT_EQUAL(2, (int)synToCol.size());
    map<string, int>::const_iterator siIt = synToCol.find("Company");
    CPPUNIT_ASSERT(siIt != synToCol.end());
    CPPUNIT_ASSERT_EQUAL(0, siIt->second);
    siIt = synToCol.find("Country");
    CPPUNIT_ASSERT(siIt != synToCol.end());
    ...
    CPPUNIT_ASSERT_EQUAL(4, (int)records.size());
    record.reset();
    record.add_value("Microsoft");
    record.add_value("USA");
    CPPUNIT_ASSERT_EQUAL(record, records[0]);
    record.reset();
    record.add_value("Sony");
    record.add_value("Japan");
    CPPUNIT_ASSERT_EQUAL(record, records[1]);
    record.reset();
    record.add_value("Foxconn");
    record.add_value("China");
    CPPUNIT_ASSERT_EQUAL(record, records[2]);
    record.reset();
    record.add_value("Toyota");
    record.add_value("Japan");
    CPPUNIT_ASSERT_EQUAL(record, records[3]);
    tableTwo = rTable.checkout_table("Age");
    ...
    CPPUNIT_ASSERT(isIt != colToSynTwo.end());
    CPPUNIT_ASSERT_EQUAL(string("Name"), isIt->second);
    isIt = colToSynTwo.find(1);
    CPPUNIT_ASSERT(isIt != colToSynTwo.end());
    CPPUNIT_ASSERT_EQUAL(string("Age"), isIt->second);
    const map<string, int>& synToColTwo = table->get_synonym_to_col();
    CPPUNIT_ASSERT_EQUAL(2, (int)synToColTwo.size());
    siIt = synToColTwo.find("Name");
    CPPUNIT_ASSERT(siIt != synToColTwo.end());
    CPPUNIT_ASSERT_EQUAL(0, siIt->second);
    siIt = synToColTwo.find("Age");
    CPPUNIT_ASSERT(siIt != synToColTwo.end());
    CPPUNIT_ASSERT_EQUAL(1, siIt->second);
    const vector<Record>& recordsTwo = table->get_records();
    CPPUNIT_ASSERT_EQUAL(3, (int)recordsTwo.size());
    record.reset();
    record.add_value("Mr. A");
    record.add_value(42);
    CPPUNIT_ASSERT_EQUAL(record, recordsTwo[0]);
    record.reset();
    record.add_value("Bean Jackson");
    record.add_value(567);
    CPPUNIT_ASSERT_EQUAL(record, recordsTwo[1]);
    record.reset();
    record.add_value("John Tran");
    record.add_value(1);
...
{
    Record record;
    ResultsTable rTableOne;
    rTableOne.syn_00_transaction_begin("Company", RV_STRING,
            "Country", RV_STRING);
    rTableOne.syn_00_add_row("Microsoft", "USA");
    rTableOne.syn_00_add_row("Sony", "Japan");
    rTableOne.syn_00_add_row("Foxconn", "China");
    rTableOne.syn_00_add_row("Toyota", "Japan");
    rTableOne.syn_00_transaction_end();
    CPPUNIT_ASSERT_EQUAL(true, rTableOne.is_alive());
    ResultsTable rTableTwo;
    rTableTwo.syn_00_transaction_begin("Name", RV_STRING,
            "Age", RV_INT);
    rTableTwo.syn_00_add_row("Mr. A", 42);
    rTableTwo.syn_00_add_row("Bean Jackson", 567);
    rTableTwo.syn_00_add_row("John Tran", 1);
    rTableTwo.syn_00_transaction_end();
    CPPUNIT_ASSERT_EQUAL(true, rTableTwo.is_alive());
    CPPUNIT_ASSERT_EQUAL(true, rTableOne.has_synonym("Company"));
    CPPUNIT_ASSERT_EQUAL(true, rTableOne.has_synonym("Country"));
    CPPUNIT_ASSERT_EQUAL(true, rTableTwo.has_synonym("Name"));
    CPPUNIT_ASSERT_EQUAL(true, rTableTwo.has_synonym("Age"));
    rTableOne.absorb_ResultsTable(rTableTwo);
    CPPUNIT_ASSERT_EQUAL(true, rTableOne.is_alive());
    CPPUNIT_ASSERT_EQUAL(true, rTableTwo.is_alive());
    CPPUNIT_ASSERT_EQUAL(true, rTableOne.has_synonym("Company"));
    CPPUNIT_ASSERT_EQUAL(true, rTableOne.has_synonym("Country"));
    CPPUNIT_ASSERT_EQUAL(true, rTableOne.has_synonym("Name"));
    CPPUNIT_ASSERT_EQUAL(true, rTableOne.has_synonym("Age"));
    CPPUNIT_ASSERT_EQUAL(false, rTableTwo.has_synonym("Company"));
    CPPUNIT_ASSERT_EQUAL(false, rTableTwo.has_synonym("Country"));
    CPPUNIT_ASSERT_EQUAL(false, rTableTwo.has_synonym("Name"));
    CPPUNIT_ASSERT_EQUAL(false, rTableTwo.has_synonym("Age"));

    rTableOne.checkout_transaction_begin();
    ...
    record.add_value("Japan");
    CPPUNIT_ASSERT_EQUAL(record, records[3]);
    tableTwo = rTableOne.checkout_table("Age");
    CPPUNIT_ASSERT(table != tableTwo);
