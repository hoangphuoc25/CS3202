...
void Test_30_PKB_Parent::test_parent_while_Y()
{
    const string& simpleProg = this->TEST_MODIFIES_SIMPLE_PROG;
    string queryStr;
    set<int> intSet;
    ...
    // Parent(while,assign)
    stringSet = pkb->parent_X_Y_get_int_Y_from_int_X(ENT_WHILE,
            ENT_ASSIGN, 1);
    CPPUNIT_ASSERT_EQUAL(SetWrapper<string>(),
            stringSet);
    stringSet = pkb->parent_X_Y_get_int_Y_from_int_X(ENT_WHILE,
    ...
    stringSet = pkb->parent_X_Y_get_int_Y_from_int_X(ENT_WHILE,
            ENT_ASSIGN, 3);
    CPPUNIT_ASSERT_EQUAL(SetWrapper<string>(2, "4", "21"),
            stringSet);
    stringSet = pkb->parent_X_Y_get_int_Y_from_int_X(ENT_WHILE,
            ENT_ASSIGN, 4);
    CPPUNIT_ASSERT_EQUAL(SetWrapper<string>(),
    ...
    stringSet = pkb->parent_X_Y_get_int_Y_from_int_X(ENT_WHILE,
            ENT_ASSIGN, 5);
    CPPUNIT_ASSERT_EQUAL(SetWrapper<string>(3, "6", "19", "20"),
            stringSet);
    stringSet = pkb->parent_X_Y_get_int_Y_from_int_X(ENT_WHILE,
            ENT_ASSIGN, 6);
    CPPUNIT_ASSERT_EQUAL(SetWrapper<string>(),
    ...
    stringSet = pkb->parent_X_Y_get_int_Y_from_int_X(ENT_WHILE,
            ENT_ASSIGN, 25);
    CPPUNIT_ASSERT_EQUAL(SetWrapper<string>(1, "26"),
            stringSet);
    stringSet = pkb->parent_X_Y_get_int_Y_from_int_X(ENT_WHILE,
            ENT_ASSIGN, 26);
    CPPUNIT_ASSERT_EQUAL(SetWrapper<string>(),
    ...
    stringSet = pkb->parent_X_Y_get_int_Y_from_int_X(ENT_WHILE,
            ENT_ASSIGN, 38);
    CPPUNIT_ASSERT_EQUAL(SetWrapper<string>(1, "39"),
            stringSet);
    stringSet = pkb->parent_X_Y_get_int_Y_from_int_X(ENT_WHILE,
            ENT_ASSIGN, 39);
    CPPUNIT_ASSERT_EQUAL(SetWrapper<string>(),
    ...
    stringSet = pkb->parent_X_Y_get_int_Y_from_int_X(ENT_WHILE,
            ENT_STMT, 3);
    CPPUNIT_ASSERT_EQUAL(SetWrapper<string>(3, "4", "5", "21"),
            stringSet);
    stringSet = pkb->parent_X_Y_get_int_Y_from_int_X(ENT_WHILE,
            ENT_STMT, 4);
    CPPUNIT_ASSERT_EQUAL(SetWrapper<string>(),
    ...
    stringSet = pkb->parent_X_Y_get_int_Y_from_int_X(ENT_WHILE,
            ENT_STMT, 5);
    CPPUNIT_ASSERT_EQUAL(SetWrapper<string>(4, "6", "7", "19", "20"),
            stringSet);
    stringSet = pkb->parent_X_Y_get_int_Y_from_int_X(ENT_WHILE,
            ENT_STMT, 6);
    CPPUNIT_ASSERT_EQUAL(SetWrapper<string>(),
    ...
    stringSet = pkb->parent_X_Y_get_int_Y_from_int_X(ENT_WHILE,
            ENT_STMT, 14);
    CPPUNIT_ASSERT_EQUAL(SetWrapper<string>(2, "15", "16"),
            stringSet);
    stringSet = pkb->parent_X_Y_get_int_Y_from_int_X(ENT_WHILE,
            ENT_STMT, 15);
    CPPUNIT_ASSERT_EQUAL(SetWrapper<string>(),
    ...
    stringSet = pkb->parent_X_Y_get_int_Y_from_int_X(ENT_WHILE,
            ENT_STMT, 25);
    CPPUNIT_ASSERT_EQUAL(SetWrapper<string>(2, "26", "27"),
            stringSet);
    stringSet = pkb->parent_X_Y_get_int_Y_from_int_X(ENT_WHILE,
            ENT_STMT, 26);
    CPPUNIT_ASSERT_EQUAL(SetWrapper<string>(),
...
void Test_30_PKB_Parent::test_parent_if_Y()
{
    const string& simpleProg = this->TEST_MODIFIES_SIMPLE_PROG;
    string queryStr;
    set<int> intSet;
    ...
    // Parent(if,assign)
    stringSet = pkb->parent_X_Y_get_int_Y_from_int_X(ENT_IF,
            ENT_ASSIGN, 1);
    CPPUNIT_ASSERT_EQUAL(SetWrapper<string>(),
            stringSet);
    stringSet = pkb->parent_X_Y_get_int_Y_from_int_X(ENT_IF,
    ...
    stringSet = pkb->parent_X_Y_get_int_Y_from_int_X(ENT_IF,
            ENT_ASSIGN, 13);
    CPPUNIT_ASSERT_EQUAL(SetWrapper<string>(1, "17"),
            stringSet);
    stringSet = pkb->parent_X_Y_get_int_Y_from_int_X(ENT_IF,
            ENT_ASSIGN, 14);
    CPPUNIT_ASSERT_EQUAL(SetWrapper<string>(),
    ...
    stringSet = pkb->parent_X_Y_get_int_Y_from_int_X(ENT_IF,
            ENT_ASSIGN, 27);
    CPPUNIT_ASSERT_EQUAL(SetWrapper<string>(2, "28", "29"),
            stringSet);
    stringSet = pkb->parent_X_Y_get_int_Y_from_int_X(ENT_IF,
            ENT_ASSIGN, 28);
    CPPUNIT_ASSERT_EQUAL(SetWrapper<string>(),
    ...
    stringSet = pkb->parent_X_Y_get_int_Y_from_int_X(ENT_IF,
            ENT_ASSIGN, 31);
    CPPUNIT_ASSERT_EQUAL(SetWrapper<string>(2, "32", "33"),
            stringSet);
    stringSet = pkb->parent_X_Y_get_int_Y_from_int_X(ENT_IF,
            ENT_ASSIGN, 32);
    CPPUNIT_ASSERT_EQUAL(SetWrapper<string>(),
    ...
    stringSet = pkb->parent_X_Y_get_int_Y_from_int_X(ENT_IF,
            ENT_STMT, 7);
    CPPUNIT_ASSERT_EQUAL(SetWrapper<string>(6, "8", "9", "10",
            "11", "13", "18"),
            stringSet);
    stringSet = pkb->parent_X_Y_get_int_Y_from_int_X(ENT_IF,
            ENT_STMT, 8);
    ...
    stringSet = pkb->parent_X_Y_get_int_Y_from_int_X(ENT_IF,
            ENT_STMT, 13);
    CPPUNIT_ASSERT_EQUAL(SetWrapper<string>(2, "14", "17"),
            stringSet);
    stringSet = pkb->parent_X_Y_get_int_Y_from_int_X(ENT_IF,
            ENT_STMT, 14);
    CPPUNIT_ASSERT_EQUAL(SetWrapper<string>(),
    ...
    stringSet = pkb->parent_X_Y_get_int_Y_from_int_X(ENT_IF,
            ENT_STMT, 27);
    CPPUNIT_ASSERT_EQUAL(SetWrapper<string>(3, "28", "29", "30"),
            stringSet);
    stringSet = pkb->parent_X_Y_get_int_Y_from_int_X(ENT_IF,
            ENT_STMT, 28);
    CPPUNIT_ASSERT_EQUAL(SetWrapper<string>(),
...
void Test_30_PKB_Parent::test_parent_stmt_Y()
{
    const string& simpleProg = this->TEST_MODIFIES_SIMPLE_PROG;
    string queryStr;
    set<int> intSet;
    ...
    // Parent(stmt,assign)
    stringSet = pkb->parent_X_Y_get_int_Y_from_int_X(ENT_STMT,
            ENT_ASSIGN, 1);
    CPPUNIT_ASSERT_EQUAL(SetWrapper<string>(),
            stringSet);
    stringSet = pkb->parent_X_Y_get_int_Y_from_int_X(ENT_STMT,
    ...
    stringSet = pkb->parent_X_Y_get_int_Y_from_int_X(ENT_STMT,
            ENT_STMT, 7);
    CPPUNIT_ASSERT_EQUAL(SetWrapper<string>(6, "8", "9", "10", "11",
            "13", "18"),
            stringSet);
    stringSet = pkb->parent_X_Y_get_int_Y_from_int_X(ENT_STMT,
            ENT_STMT, 8);
...
void Test_30_PKB_Parent::test_parent_progline_Y()
{
    const string& simpleProg = this->TEST_MODIFIES_SIMPLE_PROG;
    string queryStr;
    set<int> intSet;
    ...
    // Parent(prog_line,assign)
    stringSet = pkb->parent_X_Y_get_int_Y_from_int_X(ENT_PROGLINE,
            ENT_ASSIGN, 1);
    CPPUNIT_ASSERT_EQUAL(SetWrapper<string>(),
            stringSet);
    stringSet = pkb->parent_X_Y_get_int_Y_from_int_X(ENT_PROGLINE,
